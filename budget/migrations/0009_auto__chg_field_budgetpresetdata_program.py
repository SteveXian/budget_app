...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BudgetPresetData.program'
        db.alter_column(u'budget_budgetpresetdata', 'program', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'BudgetPresetData.program'
        db.alter_column(u'budget_budgetpresetdata', 'program', self.gf('django.db.models.fields.IntegerField')())
