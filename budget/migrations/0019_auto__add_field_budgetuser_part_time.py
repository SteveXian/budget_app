...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BudgetUser.part_time'
        db.add_column(u'budget_budgetuser', 'part_time',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BudgetUser.part_time'
        db.delete_column(u'budget_budgetuser', 'part_time')
    ...
    models = {
        ...
        u'budget.budgetuser': {
            ...
            'part_time': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
